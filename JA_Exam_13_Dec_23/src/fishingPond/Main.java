...
public class Main {
    public static void main(String[] args) {
        ...
        pond.addFish(perch);
        pond.addFish(pike);
        System.out.println(pond.removeFish("Trout"));  //trueSystem.out.println(pond.removeFish("Carp"));  //false
        System.out.println(pike.getMatingSeason());  //spring
        pond.addFish(catfish);
        System.out.println(pond.getOldestFish().getSpecies());
        System.out.println(pond.getVacancies()); //2System.out.println(pond.report());
